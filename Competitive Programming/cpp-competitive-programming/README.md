...
- For solving specific problems, copy the contents of `problems/template.cpp` and modify it according to the problem requirements.
- Utilize `templates/cp_template.cpp` for common functionalities and utilities that can be reused across different problems.

## Contributing

Feel free to contribute by adding new problem templates or improving existing ones. Make sure to follow the project's structure for consistency.
